...
from core.config import CODENANO_CLI_PATH, SB_TTL_MINUTES, ANTHROPIC_AUTH_TOKEN, ANTHROPIC_BASE_URL, ANTHROPIC_MODEL, WORKSPACE_BASE_DIR
...
class SubprocessRegistry:
    ...
    async def create_session(self, config: dict | None = None) -> str:
        ...
        proc = await asyncio.create_subprocess_exec(
            ...
            env={**os.environ, "ANTHROPIC_AUTH_TOKEN": ANTHROPIC_AUTH_TOKEN, **({"ANTHROPIC_BASE_URL": ANTHROPIC_BASE_URL} if ANTHROPIC_BASE_URL else {}), "ANTHROPIC_MODEL": ANTHROPIC_MODEL},
        )
